 ...
 *   The form state.
 */
function erica_scott_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['pre_cor_sett']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','erica_scott_theme'),
  ...
  $form['pre_cor_sett']['slideshow']['slideshow_display'] = array(
    ...
    '#default_value' => theme_get_setting('slideshow_display','erica_scott_theme'),
  ...
  $form['pre_cor_sett']['slideshow']['slide1']['slide1_head'] = array(
    ...
    '#default_value' => theme_get_setting('slide1_head','erica_scott_theme'),
  );
  $form['pre_cor_sett']['slideshow']['slide1']['slide1_desc'] = array(
    '#type' => 'textarea',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide1_desc','erica_scott_theme'),
  );
  ...
  $form['pre_cor_sett']['slideshow']['slide2']['slide2_head'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Headline'),
    '#default_value' => theme_get_setting('slide2_head','erica_scott_theme'),
  );
  $form['pre_cor_sett']['slideshow']['slide2']['slide2_desc'] = array(
    '#type' => 'textarea',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide2_desc','erica_scott_theme'),
  );
  ...
  $form['pre_cor_sett']['slideshow']['slide3']['slide3_head'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Headline'),
    '#default_value' => theme_get_setting('slide3_head','erica_scott_theme'),
  );
  $form['pre_cor_sett']['slideshow']['slide3']['slide3_desc'] = array(
    '#type' => 'textarea',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide3_desc','erica_scott_theme'),
  );
