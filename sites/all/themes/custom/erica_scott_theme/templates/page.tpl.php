...
<div id="wrap" class="clearfix">
  <?php if ($is_front): ?>
  <?php if (theme_get_setting('slideshow_display','erica_scott_theme')): ?>
    <?php 
  $slide1_head = check_plain(theme_get_setting('slide1_head','erica_scott_theme')); 
  $slide2_head = check_plain(theme_get_setting('slide2_head','erica_scott_theme')); 
  $slide3_head = check_plain(theme_get_setting('slide3_head','erica_scott_theme')); 
  $slide1_desc = check_markup(theme_get_setting('slide1_desc','erica_scott_theme'), 'full_html'); 
  $slide2_desc = check_markup(theme_get_setting('slide2_desc','erica_scott_theme'), 'full_html'); 
  $slide3_desc = check_markup(theme_get_setting('slide3_desc','erica_scott_theme'), 'full_html'); 
  ...
  <div id="slider-wrap">
    <div id="slider_nivo" class="nivoSlider"> 
      <img src="<?php print base_path() . drupal_get_path('theme', 'erica_scott_theme') . '/images/slide-image-1.jpg'; ?>" height="360" width="970" <?php if ($slide1_cap) { print 'title="#caption0"'; } ?> />
      <img src="<?php print base_path() . drupal_get_path('theme', 'erica_scott_theme') . '/images/slide-image-2.jpg'; ?>" height="360" width="970" <?php if ($slide2_cap) { print 'title="#caption1"'; } ?> />
      <img src="<?php print base_path() . drupal_get_path('theme', 'erica_scott_theme') . '/images/slide-image-3.jpg'; ?>" height="360" width="970" <?php if ($slide3_cap) { print 'title="#caption2"'; } ?> />
    </div>
